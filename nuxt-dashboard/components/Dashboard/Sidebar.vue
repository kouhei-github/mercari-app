        ...
        <li v-for="i in 17" :key="i">
          ...
          >
            ...
            <span
              ...
              :class="{
                'font-extrabold text-sky-500 dark:text-sky-400': i === 2,
              }"
            >
